...
export const ThemeRick = createTheme({
  palette: {
    ...
    background: {
      ...
      paper:
        "linear-gradient(304deg, rgb(64 243 74) 0%, rgb(244 237 32) 10%, rgb(143 199 72) 24%, rgb(143 199 72) 42%, rgb(60 182 74) 53%, rgb(143 199 72) 59%, rgb(143 199 72) 68%, rgb(210 224 84) 88%, rgba(63,254,61,1) 100%)",
    },
    text: {
      primary: "#ffffff",
    },
